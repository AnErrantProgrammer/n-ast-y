...
/* harmony import */ var core_js_modules_es_string_starts_with__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("2ca0");
...
/* harmony import */ var C_Work_anerrantprogrammer_n_ast_y_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("53ca");
/* harmony import */ var _language_Syntax_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("561e");
/* harmony import */ var _language_Parts_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("15aa");
/* harmony import */ var _language_Values_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("50de");
/* harmony import */ var _language_Properties_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("3dea");
/* harmony import */ var _validations_sample_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("476a");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("b166");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("2ef0");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var chance__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("9e67");
/* harmony import */ var chance__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(chance__WEBPACK_IMPORTED_MODULE_18__);
...
var chance = new chance__WEBPACK_IMPORTED_MODULE_18___default.a();
/* harmony default export */ __webpack_exports__["a"] = ({
  name: 'App',
  data: function data() {
    return {
      programState: 'stopped',
      syntax: _language_Syntax_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"],
      partWeights: _language_Parts_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"],
      propertyWeights: _language_Properties_js__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"],
      valueWeights: _language_Values_js__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"],
      program: '',
      programs: [],
      nextGenPrograms: [],
      ...
      selectedPart: null,
      sampleValidations: _validations_sample_js__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"],
      selectedValidation: _validations_sample_js__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"].SUM_2,
      validations: _validations_sample_js__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"].SUM_2.validations,
      validationInputs: {},
      mutatedProgram: '',
  ...
  computed: {
    validationInputKeys: function validationInputKeys() {
      return Object.keys(lodash__WEBPACK_IMPORTED_MODULE_17___default.a.cloneDeep(this.validations[0].inputs));
    },
    ...
    programSource: function programSource() {
      if (Object(C_Work_anerrantprogrammer_n_ast_y_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(this.program) === 'object') {
  ...
  methods: {
    firstProgram: function firstProgram() {
      var vm = this;
    ...
    createGeneration: function createGeneration() {
      ...
      lodash__WEBPACK_IMPORTED_MODULE_17___default.a.forEach(vm.nextGenPrograms, function (nextGenProgram) {
    ...
    logOutput: function logOutput(message) {
      ...
      var textnode = document.createTextNode(Object(date_fns__WEBPACK_IMPORTED_MODULE_16__[/* default */ "a"])(new Date(), 'yyyy-MM-dd HH:mm:ss') + ': ' + message);
    ...
    deWeightLearnedSyntax: function deWeightLearnedSyntax() {
      ...
      lodash__WEBPACK_IMPORTED_MODULE_17___default.a.forEach(vm.partWeights, function (partWeights) {
    ...
    validateProgram: function validateProgram() {
      ...
      lodash__WEBPACK_IMPORTED_MODULE_17___default.a.forEach(vm.validationInputs, function (validationInput, key) {
        try {
      ...
      estraverse.traverse(ast, {
        enter: function enter(node, parent) {
          if (node.type !== 'Program') {
            ...
            var partIndex = lodash__WEBPACK_IMPORTED_MODULE_17___default.a.findIndex(vm.partWeights[node.type][0], function (e) {
              return e == node._id;
            });
    ...
    mutateNode: function mutateNode(node) {
      ...
      lodash__WEBPACK_IMPORTED_MODULE_17___default.a.forEach(syntax, function (syntaxPart) {
        try {
          ...
          if (action == 'mutate') {
            ...
            if (syntaxPart.type === 'Static') {
              ...
              node.scope = lodash__WEBPACK_IMPORTED_MODULE_17___default.a.cloneDeep(node.scope);
              ...
              if (bodyMutationType == 'mutate') {
                ...
                node[syntaxPart.key] = lodash__WEBPACK_IMPORTED_MODULE_17___default.a.shuffle(node[syntaxPart.key]);
              }
            }
          }
        } catch (ex) {
    ...
    createNode: function createNode(keyName, parent) {
      ...
      lodash__WEBPACK_IMPORTED_MODULE_17___default.a.forEach(vm.syntax[key], function (syntaxPart) {
        try {
          if (syntaxPart.value == null) {
            if (typeof vm.propertyWeights[key] !== 'undefined' && typeof vm.propertyWeights[key][syntaxPart.key] !== 'undefined') {
              syntaxPart.value = vm.propertyWeights[key][syntaxPart.key];
          ...
          if (syntaxPart.type === 'Static') {
            ...
            depth++;
            nodeParts.scope = lodash__WEBPACK_IMPORTED_MODULE_17___default.a.cloneDeep(nodeParts.scope);
...
PropertyWeights.MemberExpression.object = [['ConsoleIdentifier'], [1]];
PropertyWeights.ExpressionStatement = {};
PropertyWeights.ExpressionStatement.expression = [['BinaryExpression', 'CallExpression', 'MemberExpression', 'AssignmentExpression', 'UpdateExpression'], [1, 1, 0, 5, 1]];
...
PropertyWeights.CallExpression.callee = [['LogIdentifier', 'MemberExpression'], [1, 1]];
...
// EXTERNAL MODULE: ./node_modules/bootstrap-vue/esm/index.js + 271 modules
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  Appvue_type_template_id_1bc3169e_render,
  staticRenderFns,
  false,
  null,
  null,
...
/******/ });
//# sourceMappingURL=app.1332aeeb.js.map